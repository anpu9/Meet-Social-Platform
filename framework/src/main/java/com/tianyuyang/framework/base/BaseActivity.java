...
import com.tianyuyang.framework.helper.ActivityHelper;
import com.tianyuyang.framework.utils.LanguaueUtils;
...
public class BaseActivity extends AppCompatActivity {
    ...
    protected void requestWindowPermissions() {
        Toast.makeText((Context) this, "申请窗口权限，暂时没做UI交互", Toast.LENGTH_SHORT).show();
